...
const Login: React.FC = () => {
    ...
    return (
        <div className="flex w-full h-screen">
            ...
            onChange={(e) => setData('nif', e.target.value)} className="w-full rounded border-b border-b-gray-300 px-4 py-2" placeholder="Nome do Usuário | NIF" />
            ...
            onChange={(e) => setData('senha', e.target.value)} className="w-full rounded border-b border-b-gray-300 px-4 py-2" placeholder="Palavra-passe" />
