...
export default function Configuracao() {
    ...
    return (
        <div className="flex w-full flex-col gap-4 rounded-2xl bg-white sm:h-screen">
            <div className="sticky top-0 left-0 flex justify-between items-center w-full bg-[#0153A5] p-4">
                <button className='text-white flex gap2 items-center'>
            ...
            <form onSubmit={handleSubmit} encType="multipart/form-data" className="space-y-10 mt-10 pr-4 pl-4">
                ...
                {/* BOTÕES */}
                <div className="flex justify-center gap-4 pt-4 mb-10">
                    <button type="submit" className="w-full sm:w-3/5 font-bold rounded-lg bg-[#0153A5] px-6 py-2 text-white hover:bg-blue-700">
                        Atualizar
                    </button>
                </div>
            </form>
