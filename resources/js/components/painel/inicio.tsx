    ...
    return (
        <div className="flex w-full flex-col gap-4 sm:h-[88vh] sm:flex-row">
            ...
            <div className="flex w-full flex-col gap-4 sm:w-2/5">
                {/* Planos em Alta */}
                <div className="flex h-auto flex-col rounded-2xl bg-white p-4 sm:h-[60%]">
                    <div className="top-0 z-10 bg-white pb-2 font-bold">
                ...
                {/* Comentários */}
                <div className="flex h-auto flex-col rounded-2xl bg-white p-4 sm:h-[40%]">
                    ...
                    <div className="pb-16 sm:pb-0 scrollbar-thin scrollbar-thumb-gray-300 flex-1 overflow-y-auto pr-1">
                        <ComentariosLista />
                    </div>
                </div>
            </div>
